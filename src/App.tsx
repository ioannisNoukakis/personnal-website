...
export const App: React.FC = () => {
    const [engine] = useState(new ThreeDEngine());
    ...
    return (
        <>
            <canvas className="canvas" ref={onCanvas}/>
            <div className="main" ref={onDiv}>
                ...
                <section className="left4">
                    ...
                    <p>
                        ...
                        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                        laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in
                        voluptateuotes to docker build env to fix it. velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat
                        non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    <h3>Burger King</h3>
                    <p>
